import { g as getContext, f as setContext, q as split_css_unit, c as create_ssr_component, e as escape, a as add_attribute, d as compute_slots, s as subscribe, r as createEventDispatcher, k as spread, m as escape_object, v as validate_component, p as missing_component, i as each } from "../../chunks/ssr.js";
...
const cBackdrop$1 = "fixed top-0 left-0 right-0 bottom-0 overflow-y-auto";
...
const hamburger = "/_app/immutable/assets/menu.65a4dcec.svg";
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  initializeStores();
  getToastStore();
  getDrawerStore();
  return `${validate_component(Toast, "Toast").$$render($$result, { position: "t" }, {}, {})} ${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})} ${validate_component(Drawer, "Drawer").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="flex flex-col items-center divide-y-2 divide-tertiary-300 h-3/4"><a class="h1 text-center content-center h-1/3 w-full" href="/content/worksheets" data-svelte-h="svelte-s540z9">Worksheets</a> <a class="h1 text-center content-center h-1/3 w-full" href="/content/videos" data-svelte-h="svelte-i1lezf">Videos</a> <a class="h1 text-center content-center h-1/3 w-full" href="/content/articles" data-svelte-h="svelte-581vxx">Articles</a>        <div class="w-full"></div></div>`;
    }
  })} ${validate_component(AppShell, "AppShell").$$render(
    $$result,
    {
      class: "bg-gradient-to-r from-variant-filled-primary to-variant-filled-secondary"
    },
    {},
    {
      pageFooter: () => {
        return `<div class="flex flex-col lg:flex-row gap-10 lg:gap-32 justify-center p-5 text-variant-filled-primary py-20 bg-white mt-40" data-svelte-h="svelte-1usqgvw"><div class="flex flex-col gap-8"><h2 class="h2 font-semibold">JustLikeTherapy</h2> <h4 class="h4 font-semibold">Get a handle on your mental health</h4></div> <div class="h-full flex flex-col justify-normal gap-4 items-start"><h2 class="h1 md:h2 text-primary-500 font-medium">Explore</h2> <a href="/content/worksheets" class="h4 hover:text-tertiary-500">Worksheets</a> <a href="/content/videos" class="h4 hover:text-tertiary-500">Videos</a> <a href="/content/articles" class="h4 hover:text-tertiary-500">Articles</a></div> <div class="h-full flex flex-col justify-normal gap-4 items-start"><h2 class="h2 text-primary-500 font-medium">Legal</h2> <a href="/legal/terms" class="h4 hover:text-tertiary-500">Term</a> <a href="/legal/privacy" class="h4 hover:text-tertiary-500">Privacy</a></div> <div class="h-full flex flex-col justify-normal gap-4 items-start"><h2 class="h2 text-primary-500 font-medium">Help us</h2> <a href="/bugs" class="h4 hover:text-tertiary-500">Bugs Report/Feature Request</a></div></div> `;
      },
      header: () => {
        return `${validate_component(AppBar, "AppBar").$$render(
          ...
          {
            trail: () => {
              return `<button class="btn lg:hidden" data-svelte-h="svelte-w8q564"><img${add_attribute("src", hamburger, 0)} alt=""></button> <div class="hidden lg:flex flex-row pr-20 space-x-10" data-svelte-h="svelte-efjy50"><a href="/content/worksheets"><button class="btn btn-md hover:variant-ghost-primary font-semibold">Worksheets</button></a> <a href="/content/videos"><button class="btn btn-md hover:variant-ghost-primary font-semibold">Videos</button></a> <a href="/content/articles"><button class="btn btn-md hover:variant-ghost-primary font-semibold">Articles</button></a> <a href="/recommendations"><button class="btn btn-md hover:variant-ghost-primary font-semibold">Recommendations</button></a>     </div>                               `;
            },
            lead: () => {
              return `<a class="btn btn-lg variant-ghost-primary" href="/" data-svelte-h="svelte-jn9mrb">Home</a>`;
            }
          }
        )} `;
      },
